 ...
 <body>
  <div class="container">
     ...
     <div id="button" class="mt10">
       ...
       <input type="button" name="button" class="btn btn82 btn_search" value="查询1">   
       <input type="button" name="button" class="btn btn82 btn_search" value="TES1T" onclick="ymPrompt.win('login.html',500,300,'腾讯QQ官方网站',null,null,null,true)" />   
