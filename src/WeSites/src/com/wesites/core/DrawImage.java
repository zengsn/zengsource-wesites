...
/**
 * 鐢熸垚闅忔満鍥剧墖锛岀敤鏉ヤ綔涓洪獙璇佺爜
 */
public class DrawImage extends HttpServlet {
    private static final long serialVersionUID = 3038623696184546092L;
    
    public static final int WIDTH = 120;//鐢熸垚鐨勫浘鐗囩殑瀹藉害
    public static final int HEIGHT = 30;//鐢熸垚鐨勫浘鐗囩殑楂樺害
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String createTypeFlag = request.getParameter("createTypeFlag");//鎺ユ敹瀹㈡埛绔紶閫掔殑createTypeFlag鏍囪瘑
        //1.鍦ㄥ唴瀛樹腑鍒涘缓涓�紶鍥剧墖
        ...
        drawRandomLine(g);
        //6.鍐欏湪鍥剧墖涓婇殢鏈烘暟
        //String random = drawRandomNum((Graphics2D) g,"ch");//鐢熸垚涓枃楠岃瘉鐮佸浘鐗�        //String random = drawRandomNum((Graphics2D) g,"nl");//鐢熸垚鏁板瓧鍜屽瓧姣嶇粍鍚堢殑楠岃瘉鐮佸浘鐗�        //String random = drawRandomNum((Graphics2D) g,"n");//鐢熸垚绾暟瀛楃殑楠岃瘉鐮佸浘鐗�        //String random = drawRandomNum((Graphics2D) g,"l");//鐢熸垚绾瓧姣嶇殑楠岃瘉鐮佸浘鐗�        
        String random = drawRandomNum((Graphics2D) g,createTypeFlag);//鏍规嵁瀹㈡埛绔紶閫掔殑createTypeFlag鏍囪瘑鐢熸垚楠岃瘉鐮佸浘鐗�        //7.灏嗛殢鏈烘暟瀛樺湪session涓�        
        request.getSession().setAttribute("checkcode", random);
        System.out.println((String) request.getSession().getAttribute("checkcode"));
        //8.璁剧疆鍝嶅簲澶撮�鐭ユ祻瑙堝櫒浠ュ浘鐗囩殑褰㈠紡鎵撳紑
        response.setContentType("image/jpeg");//绛夊悓浜巖
        response.setHeader("Content-Type", "image/jpeg");
        //9.璁剧疆鍝嶅簲澶存帶鍒舵祻瑙堝櫒涓嶈缂撳瓨
     ...
     * @return
     * String... createTypeFlag鏄彲鍙樺弬鏁帮紝
     * Java1.5澧炲姞浜嗘柊鐗规�锛氬彲鍙樺弬鏁帮細閫傜敤浜庡弬鏁颁釜鏁颁笉纭畾锛岀被鍨嬬‘瀹氱殑鎯呭喌锛宩ava鎶婂彲鍙樺弬鏁板綋鍋氭暟缁勫鐞嗐�娉ㄦ剰锛氬彲鍙樺弬鏁板繀椤讳綅浜庢渶鍚庝竴椤�     */
    private String drawRandomNum(Graphics2D g,String... createTypeFlag) {
        ...
        //createTypeFlag[0]==null琛ㄧず娌℃湁浼犻�鍙傛暟
