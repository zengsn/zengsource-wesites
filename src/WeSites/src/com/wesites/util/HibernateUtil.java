...
public class HibernateUtil {
	...
	/*
	 * public static final SessionFactory sessionFactory; static { try{
	 * sessionFactory=new
	 ...
	 * }
	 * 
	 * public Transaction beginTransaction() { Transaction
	 * trans=this.getCurrentSession().beginTransaction(); return trans; }
	 */
}
